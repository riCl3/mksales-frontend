        ...
        <div>
          ...
          <ul className="space-y-3 text-slate-400 text-sm">
            <li className="flex items-start gap-2">
              ...
              <a href="tel:+917063208937" className="hover:text-brand-blue transition-colors">+91 - 7063208937</a>
            </li>
            <li className="flex items-start gap-2">
              <svg className="w-4 h-4 mt-0.5 text-brand-green shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:info@mksalesindia.in" className="hover:text-brand-blue transition-colors">info@mksalesindia.in</a>
            </li>
            <li className="flex items-start gap-2">
              <svg className="w-4 h-4 mt-0.5 text-brand-green shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
              ...
              <a href="https://maps.google.com/?q=Agresan+Road+Khalpara+Siliguri+734005" target="_blank" rel="noopener noreferrer" className="hover:text-brand-blue transition-colors">Agresan Road, Khalpara, Siliguri - 734005</a>
            </li>
          </ul>
        </div>
      </div>
