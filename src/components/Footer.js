...
export default function Footer() {
  return (
    <footer className="relative bg-slate-900 dark:bg-zinc-950 text-white pt-20 pb-8 overflow-hidden">
      {/* Subtle top gradient */}
        ...
        <div>
          ...
          <ul className="space-y-3 text-slate-400 text-sm">
            <li className="flex items-start gap-2">
              <svg className="w-4 h-4 mt-0.5 text-brand-green shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
